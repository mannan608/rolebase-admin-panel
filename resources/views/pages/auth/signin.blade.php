                        ...
                        <div>
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    ...
                                    <a href={{ route('pages.auth.signup') }} class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign
                                        Up</a>
                                </p>
                            </div>
                            <div class="mt-4 bg-gray-100 dark:bg-gray-800 p-3 rounded-lg">
                                <p class="text-xs font-medium text-gray-600 dark:text-gray-300 mb-2">Demo Credentials:</p>
                                <p class="text-xs text-gray-700 dark:text-gray-400"><strong>Email:</strong>
                                    admin@example.com</p>
                                <p class="text-xs text-gray-700 dark:text-gray-400"><strong>Password:</strong> password</p>
                            </div>
                        </div>
                    </div>
                </div>
